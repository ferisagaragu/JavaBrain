...
public class ElevationEffect {
    ...
    public void paint(Graphics g) {
        ...
        g.drawImage(Shadow.renderShadow(target.getWidth(), target.getHeight(), level.getValue()), 0, 0, null);
    }
    ...
    public static class Circular extends ElevationEffect {
        ...
        @Override
        public void paint(Graphics g) {
            g.drawImage(Shadow.renderCircularShadow(target.getWidth(), level.getValue()), 0, 0, null);
        }
    }
}
