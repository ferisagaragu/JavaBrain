...
public class ElevationEffectRectangle {
    ...
    public void paint(Graphics g) {
        ...
        g.drawImage(ShadowRectangle.renderShadow(target.getWidth(), target.getHeight(), level.getValue()), 0, 0, null);
    }
    ...
    public static class Circular extends ElevationEffectRectangle {
        ...
        @Override
        public void paint(Graphics g) {
            g.drawImage(ShadowRectangle.renderCircularShadow(target.getWidth(), level.getValue()), 0, 0, null);
        }
    }
}
