...
import org.javabrain.swing.ui.PasswordFieldUI;
    ...
    public PasswordField() {
        ...
        setCaret(new DefaultCaret() {
            ...
            protected synchronized void damage(Rectangle r) {
               PasswordField.this.repaint(); //fix caret not being removed completely
            }
        });
        ...
        setOpaque(true);
        setUI(new PasswordFieldUI(hint,hintColor,getFont().getSize(),getFont().getStyle(),getFont().getName()));
