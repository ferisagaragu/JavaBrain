...
public class ListBeanInfo extends SimpleBeanInfo{
    ...
    public ListBeanInfo() {
        icon16 = loadImage("/res/beaninfo/list16.png");
        icon32 = loadImage("/res/beaninfo/list32.png");
        icon16M = loadImage("/res/beaninfo/list16.png");
        icon32M = loadImage("/res/beaninfo/list32.png");
    }
