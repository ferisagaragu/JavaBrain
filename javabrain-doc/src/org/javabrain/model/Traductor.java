...
public class Traductor {
    ...
    public static boolean traslateComponet(ArrayList<ComponentTranslate> component,Language language){
        
        boolean resp = false;
        
        for (ComponentTranslate object : component) {
           
            switch(object.getType()){
                
                case 0: 
                JLabel label = (JLabel) object.getComponent();
                label.setText(autoTraslate(language,label.getText())
                .replace("</ p>","</p>")
                .replace("</ b>","</b>")
                .replace("</ html>","</html>")
                .replace("</ h2>","</h2>")
                ...
                case 1: 
                JButton button = (JButton) object.getComponent();
                button.setText(autoTraslate(language,button.getText())
                .replace("</ p>","</p>")
                .replace("</ b>","</b>")
                .replace("</ html>","</html>")
                .replace("</ h2>","</h2>")
